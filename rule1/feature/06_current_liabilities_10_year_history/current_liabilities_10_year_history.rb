...
class Current_liabilities_10_year_history
  ...
  aXPath = "//text()[. = 'total liabilities']/parent::*/following-sibling::*"
  ...
  HtmlParser.putsElements2(elements, "Current_liabilities_10_year_history")
  HtmlParser.writeElementsToTextFile(elements, "./results/textFile.txt", "Current_liabilities_10_year_history" )
